...
public enum CreditCardType {
	...
	VISA("^4\\d*$", "^4$", 16, 16, 3, "CVV", new int[] { 4, 8, 12 }),
	MASTERCARD("^(5[1-5]|222[1-9]|2[3-6]|27[0-1]|2720)\\d*$", "^(5|5[1-5]|2|22|222|222[1-9]|2[3-6]|27[0-1]|2720)$", 16, 16,
			3, "CVC", new int[] { 4, 8, 12 }), 
	DISCOVER("^(6011|65|64[4-9])\\d*$", "^(6|60|601|6011|65|64|64[4-9])$",16, 16, 3, "CID", new int[] { 4, 8, 12 }), 
	AMEX("^(3|34|37)$", "^3[47]\\d*$", 15, 15, 4, "CID",new int[] { 4, 10 }), 
	DINERS_CLUB("^3(0[0-5]|[689])\\d*$", "^(3|3[0689]|30[0-5])$", 14, 14,3, "CVV", new int[] { 4, 10 }), 
	JCB("^(2131|1800|35)\\d*$","^(2|21|213|2131|1|18|180|1800|3|35)$", 16, 16, 3, "CVV",new int[] { 4, 8, 12 }), 
	MAESTRO("^5[06-9]\\d*$", "^(5|5[06-9]|6\\d*)$", 12,19, 3, "CVC", new int[] { 4, 8, 12 }), 
	UNIONPAY("^62\\d*$","^(6|62)$", 16, 19, 3, "CVN",new int[] { 4, 8, 12 }),
	UNKNOWN("\\d+$", "\\d+$", 12, 19,3, "CVV", new int[] { 4, 8, 12 }), 
	EMPTY("^$", "^$",12, 19, 3, "CVV", null);
	...
	/**
	 * @return The android resource id for the security code name for this card
	 *         type.
	 */
	...
	/**
	 * @return the locations where spaces should be inserted when formatting the
	 *         card in a user friendly way. Only for display purposes.
	 */
